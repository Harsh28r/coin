...
const STATIC_ROUTES = [
  ...
  { path: '/ai-papers', priority: '0.85', changefreq: 'daily' },
  ...
  { path: '/tools/gas/ethereum', priority: '0.9', changefreq: 'hourly' },
  { path: '/tools/gas/polygon', priority: '0.95', changefreq: 'hourly' },
  { path: '/tools/gas/arbitrum', priority: '0.95', changefreq: 'hourly' },
  { path: '/tools/gas/base', priority: '0.95', changefreq: 'hourly' },
  { path: '/tools/gas/optimism', priority: '0.85', changefreq: 'hourly' },
  { path: '/tools/gas/bsc', priority: '0.85', changefreq: 'hourly' },
  { path: '/tools/scam-check', priority: '0.95', changefreq: 'daily' },
  { path: '/tools/unlocks', priority: '0.9', changefreq: 'daily' },
  { path: '/tools/funding', priority: '0.9', changefreq: 'hourly' },
  { path: '/tools/p2p', priority: '0.95', changefreq: 'hourly' },
  { path: '/tools/liquidations', priority: '0.85', changefreq: 'hourly' },
  { path: '/tools/profit-calculator', priority: '0.9', changefreq: 'weekly' },
  { path: '/tools/dca-calculator', priority: '0.9', changefreq: 'weekly' },
  { path: '/tools/staking-calculator', priority: '0.85', changefreq: 'weekly' },
  { path: '/tools/liquidation-calculator', priority: '0.9', changefreq: 'weekly' },
  { path: '/tools/crypto-tax-calculator', priority: '0.95', changefreq: 'weekly' },
  { path: '/in', priority: '0.95', changefreq: 'weekly' },
  { path: '/in/buy-usdt', priority: '0.95', changefreq: 'weekly' },
  { path: '/in/usdt-inr-p2p', priority: '0.95', changefreq: 'weekly' },
  { path: '/in/crypto-tax', priority: '0.95', changefreq: 'weekly' },
  { path: '/in/how-to-buy-bitcoin', priority: '0.95', changefreq: 'weekly' },
  { path: '/in/scam-check-guide', priority: '0.9', changefreq: 'weekly' },
  { path: '/in/upi-crypto', priority: '0.9', changefreq: 'weekly' },
  { path: '/in/best-crypto-apps', priority: '0.85', changefreq: 'monthly' },
  { path: '/in/crypto-banking', priority: '0.85', changefreq: 'monthly' },
  { path: '/in/ethereum-gas-india', priority: '0.85', changefreq: 'weekly' },
  { path: '/in/funding-rates-basics', priority: '0.85', changefreq: 'weekly' },
  { path: '/etf/bitcoin-flows', priority: '0.95', changefreq: 'hourly' },
  { path: '/alerts', priority: '0.8', changefreq: 'weekly' },
...
function buildProgrammaticPaths() {
  ...
  for (const id of PROGRAMMATIC_COINS) {
    paths.push({ loc: `/price/${id}`, lastmod: today, changefreq: 'hourly', priority: '0.95' });
