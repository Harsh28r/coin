...
const DefaultSEO: React.FC = () => {
  ...
  const { title, description } = useMemo(() => {
    const map: Record<string, { title: string; description: string }> = {
      '/': {
        title: 'Crypto News, Prices, and Insights | CoinsClarity',
        description:
      ...
      '/listings': {
        title: 'Latest Crypto Listings & Market Pairs | CoinsClarity',
        description:
      ...
      '/All-Trending-news': {
        title: 'Trending Crypto News Today | CoinsClarity',
        description:
    ...
    return (
      map[location.pathname] || {
        title: 'CoinsClarity | Be Crypto Aware',
        description:
