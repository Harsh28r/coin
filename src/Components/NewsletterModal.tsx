      ...
      <div className="nl-modal" onClick={(e) => e.stopPropagation()}>
        ...
        {status === 'done' ? (
          <div className="nl-done">
            ...
            <h2>You're in.</h2>
            <p>We&apos;ll send you the day&apos;s 3 most important crypto stories every day at 12:00 PM IST. No spam, unsubscribe anytime.</p>
          </div>
        ) : (
          <>
            ...
            <p className="nl-sub">
              Every day at 12:00 PM IST, we send the day's three most important crypto stories — distilled, no fluff. Read in
