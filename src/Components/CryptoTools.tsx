          ...
          <div className="mb-5">
            ...
            <div className="row g-3">
              {[
                ...
                { to: '/tools/profit-calculator', emoji: '🧮', title: 'Profit Calculator', dek: 'ROI from buy/sell price and size.' },
                { to: '/tools/crypto-tax-calculator', emoji: '🧾', title: 'India Tax Calculator', dek: 'Flat 30% VDA estimate — educational.' },
                { to: '/tools/dca-calculator', emoji: '📅', title: 'DCA Calculator', dek: 'Plan weekly/monthly buys.' },
                { to: '/tools/liquidation-calculator', emoji: '⚠️', title: 'Liq Price Calculator', dek: 'Estimate futures liquidation levels.' },
                { to: '/tools/staking-calculator', emoji: '🌱', title: 'Staking Calculator', dek: 'APY / compound illustrations.' },
