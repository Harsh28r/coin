  ...
  return (
    <div className="cd-shell">
      ...
      <div className="cd-container cd-main">
        ...
        <div className="cd-third-party-wrap">
          <HighPerformanceFormatSlot lazy className="cd-ad-slot" />
        </div>
        ...
        <AdSenseSlot placement="coin-btf" size="tools" lazy className="cd-ad-slot" />
      </div>
    </div>
  );
};
